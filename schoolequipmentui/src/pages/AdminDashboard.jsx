...
import { getEquipmentList, addItem, deleteItem, getRequests } from "../api/apiConfig";
// import "./styles.css";
...
export default function AdminDashboard({ user }) {
  ...
  async function handleAddItem(e) {
    e.preventDefault();
    try {
      await addItem({ ...newItem, quantity: parseInt(newItem.quantity) });
            ...
            <tr key={it.id || it.equipmentId}>
              ...
              <td>
                <button
                  ...
                  onClick={() => handleDelete(it.id || it.equipmentId)}
                >
                  Delete
                </button>
              </td>
